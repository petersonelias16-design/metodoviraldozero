  ...
  return (
    <header className="w-full py-8 px-4 flex flex-col items-center justify-center text-center mb-8">
      <div className="mb-2">
         ...
         <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 via-orange-500 via-pink-500 to-purple-600 pb-1 filter drop-shadow-sm">
           Método Viral <br/><span className="text-4xl md:text-6xl block mt-1">do Zero</span>
         </h1>
      </div>
